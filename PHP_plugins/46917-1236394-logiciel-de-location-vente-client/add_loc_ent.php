...
<!-- fwtable fwsrc="Sans titre" fwbase="index.jpg" fwstyle="Dreamweaver" fwdocid = "197084870" fwnested="0" -->
  ...
  <tr>
   ...
   <td colspan="5" rowspan="2" valign="top" background="images/index_r7_c4.jpg"><hr />
     <table width="50%" border="0" align="center" cellpadding="0" cellspacing="0">
     <tr>
       <td width="14%"><img src="caisse.png" width="64" height="64" /></td>
       <td width="86%"><strong>Interface de vente : </strong></td>
     </tr>
   </table>
     <hr />
     <table width="80%" border="0" align="center" cellpadding="0" cellspacing="5">
       <tr>
         <td height="43">&nbsp;</td>
         <td valign="top">
           <select name="contenu" class="tarifs" >
             <option>Location</option>
             <option selected="selected">Entretien</option>
            </select>
          </td>
       </tr>
       <tr>
         <td>De : </td>
         <td><textarea name="description" cols="40" rows="4" wrap="physical" class="Style3" id="description">Par exemple : 1 Rosalie + 2 vélo
+ temps si Location à l'heure !</textarea></td>
       </tr>
       <tr>
         <td height="17">&nbsp;</td>
         <td>&nbsp;</td>
       ...
       <tr>
         <td bgcolor="#FF9999">Date : </td>
         <td bgcolor="#FF9999"><?php
$date = date('Y'); //On prend l'année en cours
 ...
 ?>(<strong> Année/Moi/Jour  </strong> )</td>
       </tr>
       <tr>
         <td height="18" bgcolor="#99CC66">Retour : </td>
         <td bgcolor="#99CC66"><?php
 $date = date('Y'); //On prend l'année en cours
 ...
 echo "</SELECT>";
 ?>
          ( <strong>Pas pour Entretien! </strong> )</td>
       </tr>
       <tr>
         <td height="68">Prix payé : </td>
         <td>
            <input name="prix" type="text" id="prix" size="6" /> 
           € </td>
       </tr>
     </table>     
     <p align="center">
       <input type="submit" name="Submit2" value="Ajouter maintenant !" />
     </p>
     </td>
      </tr>
</table>  
...
<area shape="rect" coords="710,6,901,42" href="administration.php" alt="" />
</map>
</body>
</html>
