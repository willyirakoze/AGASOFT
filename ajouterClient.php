...
/*$req = "insert into client(MATRICULE, RECU_ENTENTE, RECU_PISCINE, NOM, PRENOM, SEXE, EMAIL, NATIONALITE, 
	DATE_NAISSANCE, PHOTO) 
	values('$matricule', $recu,$recupiscine,'$nom','$prenom','$sexe', '$email','$nationalite','$nee', 
		'$nomPhoto')";
mysql_query($req) or (die (mysql_error()));*/

/*$MONTANT="select MONTANT  from abonnement where MATRICULE='$matricule'"; */
...
alert('Client enregistrer avec succes!!!') ;

</script>";*/


/*Verification de la date de naissance */
/*$Sele= mysql_query("SELECT * from client WHERE MATRICULE='$matricule' and RECU_ENTENTE='$recu' and RECU_PISCINE ='$recupiscine'");
