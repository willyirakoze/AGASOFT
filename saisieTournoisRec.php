...
<legend><b><i>Catégorie</i></b> </legend>
	<form method= "POST" action ="" enctype= "multipart/form-data">
      ...
      <tr>
        <td>Petit: [8-12ans]</td>
        <td><button type="button" onclick = "window.location='tournois12ansrec.php'" name="12ans"> 
                Select_Garçon 
            </button>
              &nbsp&nbsp&nbsp&nbsp&nbsp
            <button type="button" onclick = "window.location= 'tournois12ansFillerec.php'" name="12ans"> Select_Fille </button></td>
      </tr>

      <tr>
        <td>Moyen: [13-16ans]</td>
        <td><button type="button" onclick = "window.location= 'tournois16ansrec.php'" name="16ans"> 
                Select_Garçon 
            </button>
                &nbsp&nbsp&nbsp&nbsp&nbsp
            <button type="button" onclick = "window.location= 'tournois16ansFillerec.php'" name="16ans"> Select_Fille </button></td>
      </tr>

      <tr>
        <td>Grand: [17-20ans]</td>
        <td><button type="button" onclick = "window.location= 'tournois20ansrec.php'" name="20ans"> 
                Select_Garçon 
            </button>
              &nbsp&nbsp&nbsp&nbsp&nbsp
            <button type="button" onclick = "window.location= 'tournois20ansFillerec.php'" name="20ans"> Select_Fille </button></td>
      </tr>
