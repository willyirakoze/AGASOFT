...
$select="SELECT client.MATRICULE,client.NOM,client.PRENOM, participe.SCORE, participe.DATE_TOURNOIS,client.SEXE,client.DATE_NAISSANCE
 FROM client, participe where client.SEXE='Masculin' and participe.MATRICULE=client.MATRICULE and (client.DATE_NAISSANCE BETWEEN '$seize_ans'
  and '$treize_ans')  ORDER BY participe.SCORE DESC  limit 0,4";
