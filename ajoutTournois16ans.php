...
{
echo "<script>
alert('Erreur car le client a déjà participé au tournois de l\'année en court.') ;
</script>";
...
mysql_query($reqScore) or (die (mysql_error()));*/
 ...
 {
echo "<script>
alert('Date du tournois ne correspond pas à l\'année en court, Veuillez corriger SVP!!!') ;
</script>";
}
